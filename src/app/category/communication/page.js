...
export const metadata = {
    title: 'Communication MCP Servers - Messaging & Email API Integrations',
    description: 'Explore the best MCP servers for communication functionality including email, messaging platforms like Slack, Discord, Teams, and social media integrations like TikTok and Bluesky.',
    keywords: ['MCP Communication', 'Email API MCP', 'Messaging API MCP', 'Slack MCP', 'Discord MCP', 'Teams MCP', 'TikTok MCP', 'Bluesky MCP', 'WhatsApp MCP'],
    openGraph: {
        type: 'website',
        url: 'https://allmcp.org/category/communication',
        title: 'Communication MCP Servers - Messaging & Email API Integrations',
        description: 'Collection of MCP servers for communication functionality including email, messaging platforms and social media integrations',
        siteName: 'AllMCP',
        images: [{
            url: 'https://allmcp.org/favicon.webp', width: 1242, height: 1242, alt: 'MCP Communication Servers Overview',
        }],
    },
    alternates: {
        canonical: 'https://allmcp.org/category/communication',
        languages: {en: 'https://allmcp.org/category/communication'},
    },
    twitter: {
        card: 'summary_large_image',
        title: 'Communication MCP Servers - Messaging & Email API Integrations',
        description: 'Connect AI models to powerful communication capabilities with these MCP servers',
