...
export const metadata = {
    title: 'Development MCP Servers - Comprehensive Development Tools & Integrations',
    description: 'Explore the best MCP servers for development including IDEs, debugging tools, version control, and specialized development APIs. Connect AI models to powerful development capabilities.',
    keywords: ['MCP Development', 'Development Tools MCP', 'IDE Integration MCP', 'Debugging MCP', 'Unity3d MCP', 'Android MCP', 'Xcode MCP', 'GDB MCP', 'Docker MCP', 'Code Sandbox MCP'],
    openGraph: {
        type: 'website',
        url: 'https://allmcp.org/category/development',
        title: 'Development MCP Servers - Comprehensive Development Tools & Integrations',
        description: 'Collection of MCP servers for development tools including IDEs, debugging, version control and specialized development APIs',
        siteName: 'AllMCP',
        images: [{
            url: 'https://allmcp.org/favicon.webp',
            width: 1242,
            height: 1242,
            alt: 'MCP Development Servers Overview',
        }],
    },
    alternates: {
        canonical: 'https://allmcp.org/category/development',
        languages: {en: 'https://allmcp.org/category/development'},
    },
    twitter: {
        card: 'summary_large_image',
        title: 'Development MCP Servers - Comprehensive Development Tools & Integrations',
        description: 'Connect AI models to powerful development tools with these MCP servers',
