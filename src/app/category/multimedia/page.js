...
export const metadata = {
    title: 'Multimedia MCP Servers - Comprehensive Multimedia API Integrations',
    description: 'Explore the best MCP servers for multimedia functionality including text-to-speech, image generation, video editing, pixel art creation, and more. Connect AI models to powerful multimedia capabilities.',
    keywords: ['Multimedia MCP', 'Text-to-Speech MCP', 'Image Generation MCP', 'Video Editing MCP', 'Pixel Art MCP', 'GIF Search MCP', 'Spotify MCP'],
    openGraph: {
        type: 'website',
        url: 'https://allmcp.org/category/multimedia',
        title: 'Multimedia MCP Servers - Comprehensive Multimedia API Integrations',
        description: 'Collection of MCP servers for multimedia functionality including text-to-speech, image generation, video editing, and more.',
        siteName: 'AllMCP',
        images: [{
            url: 'https://allmcp.org/favicon.webp', width: 1242, height: 1242, alt: 'MCP Multimedia Servers Overview',
        }],
    },
    alternates: {
        canonical: 'https://allmcp.org/category/multimedia', languages: {en: 'https://allmcp.org/category/multimedia'},
    },
    twitter: {
        card: 'summary_large_image',
        title: 'Multimedia MCP Servers - Comprehensive Multimedia API Integrations',
        description: 'Connect AI models to powerful multimedia capabilities with these MCP servers',
