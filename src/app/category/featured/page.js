...
export const metadata = {
    title: 'Featured MCP Resources - Comprehensive Collection of AI Tools',
    description: 'Explore the best featured MCP resources including Axiom, Inkeep, Thirdweb, Tavily and more. Connect AI models to powerful capabilities across various domains.',
    keywords: ['Featured MCP', 'MCP Resources', 'Axiom MCP', 'Inkeep MCP', 'Thirdweb MCP', 'Tavily MCP', 'AI Tools'],
    openGraph: {
        type: 'website',
        url: 'https://allmcp.org/category/featured',
        title: 'Featured MCP Resources - Comprehensive Collection of AI Tools',
        description: 'Collection of featured MCP resources providing powerful capabilities for AI applications',
        siteName: 'AllMCP',
        images: [{
            url: 'https://allmcp.org/favicon.webp',
            width: 1242,
            height: 1242,
            alt: 'Featured MCP Resources Overview',
        }],
    },
    alternates: {
        canonical: 'https://allmcp.org/category/featured',
        languages: {en: 'https://allmcp.org/category/featured'},
    },
    twitter: {
        card: 'summary_large_image',
        title: 'Featured MCP Resources - Comprehensive Collection of AI Tools',
        description: 'Connect AI models to powerful capabilities with these featured MCP resources',
...
export default async function CategoryPage({searchParams}) {
    const category = 'featured'; // 默认值为'featured'
