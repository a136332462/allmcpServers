...
export const metadata = {
    title: 'Blockchain MCP Servers - Comprehensive Blockchain API Integrations',
    description: 'Explore the best MCP servers for blockchain functionality including EVM networks, Solana, Bitcoin, Base Network, BNB Chain and more. Connect AI models to powerful blockchain capabilities.',
    keywords: [
        'Blockchain MCP',
        'EVM MCP',
        'Solana MCP',
    ...
    openGraph: {
        type: 'website',
        url: 'https://allmcp.org/category/blockchain',
        title: 'Blockchain MCP Servers - Comprehensive Blockchain API Integrations',
        description: 'Collection of MCP servers for blockchain functionality including EVM networks, Solana, Bitcoin and more',
        siteName: 'AllMCP',
        images: [{
            url: 'https://allmcp.org/favicon.webp',
            width: 1242,
            height: 1242,
            alt: 'Blockchain MCP Servers Overview',
        }],
    },
    alternates: {
        canonical: 'https://allmcp.org/category/blockchain',
        languages: {en: 'https://allmcp.org/category/blockchain'},
    },
    twitter: {
        card: 'summary_large_image',
        title: 'Blockchain MCP Servers - Comprehensive Blockchain API Integrations',
        description: 'Connect AI models to powerful blockchain capabilities with these MCP servers',
