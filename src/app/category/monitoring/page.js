...
export const metadata = {
    title: 'Monitoring MCP Servers - Comprehensive Monitoring Resources',
    description: 'Explore the best MCP servers for monitoring applications including Datadog, Prometheus, and InfluxDB. Integrate with AI for enhanced performance tracking.',
    keywords: ['MCP Monitoring', 'Datadog', 'Prometheus', 'InfluxDB', 'Monitoring Tools', 'AI Monitoring'],
    openGraph: {
        type: 'website',
        url: 'https://allmcp.org/category/monitoring',
        title: 'Monitoring MCP Servers - Comprehensive Monitoring Resources',
        description: 'Collection of MCP servers for monitoring functionality including Datadog, Prometheus, and InfluxDB integrations.',
        siteName: 'AllMCP',
        images: [{
            url: 'https://allmcp.org/favicon.webp', width: 1242, height: 1242, alt: 'Monitoring MCP Servers Overview',
        }],
    },
    alternates: {
        canonical: 'https://allmcp.org/category/monitoring', languages: {en: 'https://allmcp.org/category/monitoring'},
    },
    twitter: {
        card: 'summary_large_image',
        title: 'Monitoring MCP Servers - Comprehensive Monitoring Resources',
        description: 'Discover MCP servers for monitoring applications to enhance your performance tracking.',
