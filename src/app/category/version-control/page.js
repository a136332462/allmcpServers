...
export const metadata = {
    title: 'Version Control MCP Servers - Git, GitHub, GitLab & More Integrations',
    description: 'Explore the best MCP servers for version control functionality including GitHub, GitLab, Gitea, Azure DevOps and other version control system integrations. Connect AI models to powerful version control capabilities.',
    keywords: ['Version Control MCP', 'Git MCP', 'GitHub MCP', 'GitLab MCP', 'Gitea MCP', 'Azure DevOps MCP', 'Gitee MCP', 'Repository Management MCP'],
    openGraph: {
        type: 'website',
        url: 'https://allmcp.org/category/version-control',
        title: 'Version Control MCP Servers - Git, GitHub, GitLab & More Integrations',
        description: 'Collection of MCP servers for version control functionality including GitHub, GitLab, Gitea and other VCS integrations',
        siteName: 'AllMCP',
        images: [{
            url: 'https://allmcp.org/favicon.webp', width: 1242, height: 1242, alt: 'Version Control MCP Servers Overview',
        }],
    },
    alternates: {
        canonical: 'https://allmcp.org/category/version-control',
        languages: {en: 'https://allmcp.org/category/version-control'},
    },
    twitter: {
        card: 'summary_large_image',
        title: 'Version Control MCP Servers - Git, GitHub, GitLab & More Integrations',
        description: 'Connect AI models to powerful version control capabilities with these MCP servers',
...
export default async function CategoryPage({searchParams}) {
    const category = 'version-control';
