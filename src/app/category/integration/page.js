...
export const metadata = {
    title: 'Integration MCP Servers - Management Tools & Middleware Solutions',
    description: 'Discover essential MCP integration tools including server management platforms, proxy solutions, gateways and middleware for seamless MCP server deployment and operation.',
    keywords: ['MCP Integration', 'MCP Management Tools', 'MCP Proxy', 'MCP Gateway', 'MCP Middleware', 'MCP Server Control', 'MCP Registry', 'MCPHub', 'MCP Compass', 'MCP Create'],
    openGraph: {
        type: 'website',
        url: 'https://allmcp.org/category/integration',
        title: 'Integration MCP Servers - Management Tools & Middleware Solutions',
        description: 'Collection of MCP servers for integration including management platforms, proxy solutions and middleware components',
        siteName: 'AllMCP',
        images: [{
            url: 'https://allmcp.org/favicon.webp',
            width: 1242,
            height: 1242,
            alt: 'MCP Integration Tools Overview',
        }],
    },
    alternates: {
        canonical: 'https://allmcp.org/category/integration',
        languages: {en: 'https://allmcp.org/category/integration'},
    },
    twitter: {
        card: 'summary_large_image',
        title: 'Integration MCP Servers - Management Tools & Middleware Solutions',
        description: 'Connect and manage MCP servers with these essential integration tools and platforms',
